 ...
 */
public class ClinVarManager extends CvaManager {
    ...
    public static void main (String[] args)
        ...
        ClinVarManager clinVarManager = new ClinVarManager(cvaConfiguration);
        Map latest = clinVarManager.getLatest();
        System.out.print(latest.toString());
        boolean success = clinVarManager.downloadFTPFile(latest.get("path") + "/" + latest.get("name"),
                cvaConfiguration.getTempFolder() + "/" + latest.get("name"));
